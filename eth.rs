...
pub const ETHER_HEADER_TEMPLATE: EtherHeader<[u8;14]> = EtherHeader { buf: [0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x08,0x00] };
...
MacAddr::from_bytes(&self.buf.as_ref()[0..6])
}
#[inline]
pub fn src_mac(&self)->MacAddr{
MacAddr::from_bytes(&self.buf.as_ref()[6..12])
}
#[inline]
...
#[inline]
pub fn set_src_mac(&mut self, value:MacAddr){
...
#[inline]
pub fn dest_mac(&self)->MacAddr{
MacAddr::from_bytes(&self.buf.chunk()[0..6])
}
#[inline]
pub fn src_mac(&self)->MacAddr{
MacAddr::from_bytes(&self.buf.chunk()[6..12])
}
#[inline]
pub fn ethertype(&self)->EtherType{
...
#[inline]
pub fn parse_for_cursor(buf: Cursor<'a>) -> Result<Self, Cursor<'a>> {
...
#[inline]
pub fn payload_for_cursor(&self)->Cursor<'_>{
Cursor::new(&self.buf.chunk()[14..])
}
}
impl<'a> EtherPacket<CursorMut<'a>>{
#[inline]
pub fn parse_for_cursor_mut(buf: CursorMut<'a>) -> Result<Self, CursorMut<'a>> {
let remaining_len = buf.chunk().len();
if remaining_len < 14 {
return Err(buf);
}
...
#[inline]
pub fn payload_for_cursor_mut(&mut self)->CursorMut<'_>{
