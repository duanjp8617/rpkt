...
impl<T: Buf> Ipv6<T> {
    ...
    pub fn parse(buf: T) -> Result<Self, T> {
        ...
        if payload_len + 40 > container.buf.remaining() {
...
impl<'a> Ipv6<Cursor<'a>> {
    ...
    pub fn parse_from_cursor(buf: Cursor<'a>) -> Result<Self, Cursor<'a>> {
        ...
        let container = Self { buf };
        let payload_len = container.payload_len() as usize;
        if payload_len + 40 > remaining_len {
            return Err(container.buf);
        }
        Ok(container)
    }
    ...
    pub fn payload_as_cursor(&self) -> Cursor<'_> {
        ...
        self.buf.index_(40..(40 + payload_len))
    }
    #[inline]
...
impl<'a> Ipv6<CursorMut<'a>> {
    ...
    pub fn payload_as_cursor_mut(&mut self) -> CursorMut<'_> {
        let payload_len = self.payload_len() as usize;
        self.buf.index_mut_(40..(40 + payload_len))
    }
    #[inline]
...
impl<T: Buf> RoutingHeader<T> {
    ...
    pub fn parse(buf: T) -> Result<Self, T> {
        ...
        let container = Self { buf };
        let header_len = container.header_len() as usize;
        if (header_len < 8) || (header_len > chunk_len) {
            return Err(container.buf);
        }
        Ok(container)
    }
...
impl<'a> RoutingHeader<Cursor<'a>> {
    ...
    pub fn parse_from_cursor(buf: Cursor<'a>) -> Result<Self, Cursor<'a>> {
        ...
        let container = Self { buf };
        let header_len = container.header_len() as usize;
        if (header_len < 8) || (header_len > remaining_len) {
            return Err(container.buf);
        }
        Ok(container)
    }
...
impl<T: Buf> AuthenticationHeader<T> {
    ...
    pub fn parse(buf: T) -> Result<Self, T> {
        ...
        let container = Self { buf };
        let header_len = container.header_len() as usize;
        if (header_len < 12) || (header_len > chunk_len) {
            return Err(container.buf);
        }
        Ok(container)
    }
...
impl<'a> AuthenticationHeader<Cursor<'a>> {
    ...
    pub fn parse_from_cursor(buf: Cursor<'a>) -> Result<Self, Cursor<'a>> {
        ...
        let container = Self { buf };
        let header_len = container.header_len() as usize;
        if (header_len < 12) || (header_len > remaining_len) {
            return Err(container.buf);
        }
        Ok(container)
    }
