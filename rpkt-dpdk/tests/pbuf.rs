...
mod tests {
    ...
    fn pbuf_advance_helper(seglen: usize, seg_num: usize, mp: &Mempool, step: usize) {
        ...
        for _ in 0..seg_num - 1 {
            let mut seg = mp.try_alloc().unwrap();
    ...
    fn pbuf_advance_test() {
            ...
            .unwrap();
        {
            ...
            pbuf_advance_helper(1000, 5, &mp, 1);
            pbuf_advance_helper(1000, 5, &mp, 3);
            pbuf_advance_helper(1000, 5, &mp, 1000);
            pbuf_advance_helper(1000, 6, &mp, 1200);
            pbuf_advance_helper(1000, 10, &mp, 2500);
        }
    ...
    fn pbuf_moveback_helper(seglen: usize, seg_num: usize, mp: &Mempool, step: usize) {
        assert!(seglen <= 2048 && seg_num >= 1 && step <= seglen * seg_num);
    ...
    fn pbuf_moveback_test() {
            ...
            .unwrap();
        {
            ...
            pbuf_moveback_helper(1000, 5, &mp, 1);
            pbuf_moveback_helper(1000, 5, &mp, 3);
            pbuf_moveback_helper(1000, 5, &mp, 1000);
            pbuf_moveback_helper(1000, 6, &mp, 1200);
            pbuf_moveback_helper(1000, 10, &mp, 2500);
        }
